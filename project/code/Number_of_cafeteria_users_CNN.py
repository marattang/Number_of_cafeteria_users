...
from tensorflow.keras.layers import Dense, LSTM, Flatten, Input, SimpleRNN, Conv2D, GlobalAveragePooling2D, MaxPool2D
...
# x1_train = x1_train.reshape(1149, 1, 1, 8)
# x2_train = x2_train.reshape(1149, 1, 1, 8)
...
result.to_csv('./save/data/preprocess/test_result_predict_CNN.csv')
...
# CNN
# Conv2D - r2 score :  0.6821493784731307