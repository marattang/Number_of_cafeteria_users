...
model1.fit(x1_train, y1_train, batch_size=5, callbacks=[es], epochs=80)
model2.fit(x2_train, y2_train, batch_size=5, callbacks=[es], epochs=80)
...
# RNN 배운걸로만 단순 구현했을 때
# r2 score :  -2.6329840451272886
# r2 score :  -2.602071860247843
